...
export default function AboutPage() {
  return (
    <AppShell
      ...
      description="Lee is designed as a calm reading studio for people who want better pacing, clearer focus, and easier recovery when speed starts to hurt comprehension."
    >
