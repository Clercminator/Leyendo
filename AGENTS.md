...
- Do not stop after editing code. Before finishing any code change, run the relevant validation needed to keep the repo deployable.
...
- Keep solutions efficient and direct over complicated and redundant.
